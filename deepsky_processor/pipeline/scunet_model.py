# -*- coding: utf-8 -*-
"""SCUNet architecture from cszn/SCUNet.

Source: https://github.com/cszn/SCUNet/blob/main/models/network_scunet.py
License: Apache-2.0, matching the upstream repository.

DeepSky vendors this architecture so regular official SCUNet `.pth` checkpoints
can be loaded without pretending they are TorchScript files.
"""
